...
class ActorCriticAgent(FNAgent):
    ...
    def __init__(self, actions):
        # ActorCriticAgent 使用自身的策略（而非epsilon）
    ...
    def set_updater(self, optimizer,
        ...
        # tf.stop_gradient: 防止policy_loss影响critic_layer
...
class SampleLayer(K.layers.Layer):
    ...
    def __init__(self, **kwargs):
        self.output_dim = 1  # 从评价中采样，得到一个样本
...
class CatcherObserver(Observer):
    ...
    def transform(self, state):
        ...
        normalized = resized / 255.0  # 归一化为0~1的值
